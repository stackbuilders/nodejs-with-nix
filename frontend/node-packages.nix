...
let
  sources = {
    ...
    "tsutils-3.12.0" = {
      ...
      version = "3.12.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/tsutils/-/tsutils-3.12.0.tgz";
        sha512 = "64KxDOb3+5ZVbz6NDZlCtOHstLk9+W96Y7d5Z/s5ge92gLaunxDeXYahvB7Rhl1dbaa3ifyq/W53o4mshIV1Tw==";
      };
    };
